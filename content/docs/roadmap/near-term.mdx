---
title: Near-term
description: Work before mainnet. The ceremony, the audit, the operational lift, and mainnet deployment.
---
...
Pre-audit hardening runs through an internal security review and the public security program. Findings from internal red-teaming are remediated and re-tested before the external engagement begins.
