...
The current published version is `3.12.0`. Install with `npm install @entros/pulse-sdk`. See the [changelog](/docs/reference/changelog) for the upgrade path from earlier versions.
