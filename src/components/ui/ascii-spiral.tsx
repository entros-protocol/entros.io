  ...
  return (
    <pre
      ...
      className={cn(
        ...
        "ascii-art-bright",
        // Glyph size is tiny on purpose: at 80 cols × 80 rows even a 6px
        // glyph renders a ~480px block. Call sites override this ladder
        // when they need the disk at a different scale.
